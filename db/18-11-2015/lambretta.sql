...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2015 at 02:58 PM
...
`member_id` int(5) NOT NULL,
  ...
  `member_type_of_lambretta` varchar(15) NOT NULL,
  `member_plate_no` varchar(15) NOT NULL,
  `member_married` varchar(5) NOT NULL,
...
INSERT INTO `members` (`member_id`, `member_username`, `member_password`, `member_email`, `member_ic`, `member_name`, `member_gender`, `member_address`, `member_phone`, `member_type_of_lambretta`, `member_plate_no`, `member_married`, `member_profile_picture`, `member_date_created`) VALUES
(2, 'qwe', '123', 'ddd12', '55512', 'bbb2', 'hhh12', '<p>\r\n	www12222</p>\r\n', '123', 'px', 'wer345', 'yes', 'db709-img11.jpg', '2015-10-16 11:59:47'),
(10, 'qwe', '1231', 'aa@yahoo.com', '89', 'emi', 'male', 'g.datuk', '013', 'pX11', 'oiu2341', 'yes1', 'img10.jpg', '2015-11-17 15:21:33');
